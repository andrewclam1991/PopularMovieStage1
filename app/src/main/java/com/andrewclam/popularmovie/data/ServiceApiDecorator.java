...
public class ServiceApiDecorator<E extends Entity> implements DataSource<E> {
  ...
  public ServiceApiDecorator(@NonNull DataSource<E> repository) {
    mRepository = repository;
  }

  @NonNull
  public ServiceApiDecorator<E> setApiService(@NonNull OnRequestApiService<E> callback) {
   ...
   */
  @NonNull
  public ServiceApiDecorator<E> setApiKey(@NonNull OnRequestApiKeyCallback callback) {
   ...
   */
  @NonNull
  public ServiceApiDecorator<E> setQueryParams(@NonNull OnRequestOptionsCallback callback) {
   ...
   * @param apiService an instance of the generated {@link TMDBApiService<E>} api service
